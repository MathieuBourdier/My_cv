...
function switchLanguage() {
  ...
  //change the language 
    ...
    document.getElementById("realization-title").textContent = translations[currentLang].realizationTitle;
    document.getElementById("realization-text").textContent = translations[currentLang].realizationText;
